...
(function(exports) {
    ...
    var ReaderControl = function(enableAnnotations, enableOffline) {
        ...
        me.androidBrowser = userAgent.indexOf('Android') > -1 && userAgent.indexOf('Chrome') === -1 && userAgent.indexOf('Firefox') === -1;
        
        // The default android browser as well as opera seem to have some issues with fast click
        ...
        me.annotationManager.controlPointSize = 20;
        me.annotationManager.controlPointHitBoxScale = 2;
        ...
        me.buttonIdsToToolModes = {
            'editAnnotButton': toolModes.AnnotationEdit,
            'createStickyButton': exports.Tools.MobileStickyCreateTool,
            'createHighlightButton': toolModes.TextHighlightCreate,
            'createUnderlineButton': toolModes.TextUnderlineCreate,
            'createStrikeoutButton': toolModes.TextStrikeoutCreate,
            'createRectangleButton': toolModes.RectangleCreate,
            'createEllipseButton': toolModes.EllipseCreate,
            'createLineButton': toolModes.LineCreate,
            'createFreehandButton': toolModes.FreeHandCreate
        };
        ...
        me.useScaledThumbnailFallback = false;
        
        me.docViewer.SetDocumentLoadedCallback(_(this.onDocumentLoaded).bind(this));
        
        me.docViewer.SetDisplayPageLocationCallback(function(pageNumber, vpos, hpos) {
            /*jshint unused: false */
        ...
        me.annotationManager.SetAnnotationSelectedCallback(function(annotations, action) {
        ...
        me.annotationManager.SetAnnotationChangedCallback(function(annotation, action) {
            if (action === "add") {
                ...
                if (annotation instanceof Annotations.StickyAnnotation && me.$annotCreateMenuContext.is(":visible")) {
                    ...
                    me.docViewer.SetToolMode(me.docViewer.ToolModes.AnnotationEdit);
    ...
    ReaderControl.prototype = {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data !== null) {
                                ...
                                me.annotationManager.LoadAnnotations(data);
                            }
                        },
                        error: function(jqXHR, textStatus, errorThrown) {
                            ...
                            //me.annotationManager.LoadAnnotations();
                        },
                        dataType: 'xml'
                    });
                }
        ...
        bindEvents: function() {
            ...
            me.$bookmarkView.delegate('a', 'click', _(this.onBookmarkSelect).bind(this));
            ...
            $('#toggleAnnotButton').click(function() {
            ...
            $('#saveAnnotationsButton').click(function() {
                ...
                // 1) local saving
                //var xfdfString = me.annotationManager.SaveAnnotations();
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        /*jshint unused:false */
                        //Annotations was sucessfully uploaded to server
                    },
                    error: function(jqXHR, textStatus, errorThrown) {
                        /*jshint unused:false */
            ...
            $('#annotCreateButton').click(function() {
                if (me.annotationManager.GetMarkupOff()) {
                    ...
                    me.annotationManager.ToggleAnnotations();
                    $('#toggleAnnotButton').removeClass('ui-selected');
                }
            ...
            me.$annotCreateMenuContext.click(function(e) {
                ...
                if (currentToolMode instanceof me.docViewer.ToolModes.AnnotationEdit && toolMode === me.docViewer.ToolModes.AnnotationEdit) {
                    me.docViewer.SetToolMode(me.docViewer.ToolModes.Pan);
                    me.annotMode = false;
            ...
            me.$noteMenu.find('#noteSaveButton').click(function() {
                me.annotationManager.GetSelectedAnnotations()[0].SetPopupComment(me.$noteTextarea.val());
            ...
            me.$annotEditPopup.find('.colorPicker').click(function(e) {
                ...
                if ($li.length > 0) {
                    ...
                    if (color) {
                        ...
                        if (me.annotationManager.annotationChangedCallback) {
                            me.annotationManager.annotationChangedCallback(annotation, "modify");
                        }
                    }
                }
            });
            ...
            if (window.navigator.userAgent.indexOf('Android') > -1 && !me.androidBrowser) {
        ...
        initViewer: function() {
            ...
            me.docViewer.SetPageCompleteCallback(function(pageIndex, canvas) {
        ...
        offlineReady: function() {
            ...
            me.$defaultMenuContext.prepend(downloadButton);
            
            var offlineButton = $('<a>').attr({
                'id': 'offlineButton',
                'data-role': 'button',
                'data-mini': 'true',
                'data-iconpos': 'notext',
            ...
            .css('float', 'left');
            me.$defaultMenuContext.prepend(offlineButton);
            ...
            $('#offlineButton').click(function() {
                ...
                var buttonIcon = $(this).find('span.ui-icon');
                
                if (offlineEnabled) {
                    buttonIcon.removeClass('ui-icon-minus');
                    buttonIcon.addClass('ui-icon-check');
                } else {
                    buttonIcon.removeClass('ui-icon-check');
                    buttonIcon.addClass('ui-icon-minus');
                }
            });
            ...
            $('#downloadButton').click(function() {
                ...
                if (isDownloading) {
                    ...
                    var buttonIcon = $(this).find('span.ui-icon');
                    buttonIcon.removeClass('ui-icon-arrow-d');
                    buttonIcon.addClass('ui-icon-delete');
                    
                    me.doc.StoreOffline(function() {
                        $(that).data('downloading', false);
                        buttonIcon.removeClass('ui-icon-delete');
                        buttonIcon.addClass('ui-icon-arrow-d');
                        
                        if (me.doc.IsDownloaded()) {
                            $('#offlineButton').removeClass('ui-disabled');
                        }
                    });
                }
            });
            ...
            if (!me.doc.IsDownloaded()) {
                $('#offlineButton').addClass('ui-disabled');
            }
        },
        ...
        setPageMode: function(pagesPerWrapper) {
            var me = this;
            if (!_.isUndefined(pagesPerWrapper) && (pagesPerWrapper === 1 || pagesPerWrapper === 2)) {
                me.nPagesPerWrapper = pagesPerWrapper;
            } else if (window.innerWidth > window.innerHeight) {
                me.nPagesPerWrapper = 2;
            } else {
                me.nPagesPerWrapper = 1;
            }
            
            me.docViewer.SetPagesPerCanvas(me.nPagesPerWrapper);
        },
        ...
        appendCanvas: function(container, pageIndex) {
            ...
            var oldCanvas = container.find('[id^=canvas]');
        ...
        createPageWrapper: function(wrapperIndex, offset) {
            ...
            $pageWrapper.width($(window).width());
        ...
        getFitPageZoom: function(pageIndex) {
            ...
            var heightval = parseFloat($(window).height() - me.margin * 2) / height;
            var widthval = parseFloat($(window).width() - me.margin * 2) / width;
        ...
        unZoomWrapper: function() {
            ...
            if (me.zoomedWrapper) {
                ...
                me.zoomedWrapper.$e.find('canvas').css('transform', '');
        ...
        setCurrentPage: function(pageIndex) {
            ...
            if (me.c) {
                me.c.$e.find('canvas').css('transform', '');
            }
        ...
        transform: function($e, x, y, scale) {
            ...
            if (me.oldBrowser) {
                ...
                $e.css('transform', _2dstr);
                // opera doesn't support 3d transforms
                $e.css('-o-transform', _2dstr);
            }
        },
        ...
        snapBack: function(smallerThanPage, animate) {
            ...
            if (window.navigator.userAgent.indexOf('Android') > -1 && $(document.activeElement).is('textarea, input')) {
                return;
            }
        ...
        onBookmarkSelect:function(evt) {
            ...
            var pageNumber = evt.currentTarget.getAttribute("data-bookmark-page");
            if (pageNumber !== null) {
                me.setCurrentPage(parseInt(pageNumber, 10) - 1);
            } else {
        ...
        showNotePopup: function(annotation, showDelete) {
            ...
            me.$noteTextarea.val(annotation.GetPopupComment());
        ...
        setEditPopupLocation: function(annotation) {
            ...
            // if the annotation is mirrored then the x and y values aren't necessarily in the top left corner
            var pageX = annotation.GetX();
            if (annotation.GetMirroredHorizontally()) {
                pageX -= annotation.GetWidth() / 2;
            } else {
                pageX += annotation.GetWidth() / 2;
            }
            
            var pageY = annotation.GetY() - verticalOffset;
            if (annotation.GetMirroredVertically()) {
                pageY -= annotation.GetHeight();
            }
            ...
            if (location.y < height * 1.5) {
                var newPageY = annotation.GetY() + verticalOffset;
                if (!annotation.GetMirroredVertically()) {
                    newPageY += annotation.GetHeight();
                }
        ...
        mayEditAnnotation: function(annotation) {
            ...
            if (me.docViewer.onPermissionCheck) {
                permitted = me.docViewer.onPermissionCheck(annotation.Author);
            } else {
                permitted = me.annotationManager.GetIsAdminUser();
                permitted = permitted || me.annotationManager.GetCurrentUser() === annotation.Author || _.isNull(annotation.Author) || _.isUndefined(annotation.Author);
            }

            return permitted && !me.readOnly;
        },
        ...
        createBookmarkList: function (level) {
            ...
            if (_.isUndefined(level) || level === "") {
                ...
                bookmarkString += '<li data-role="list-divider" data-icon="arrow-u" data-theme="b"><a data-bookmark-level="' + levelString + '" data-i18n="mobile.bookmarks.upOneLevel"></a></li>';
            ...
            for (var j = 0; j < bookmarks.length; j++) {
                ...
                if (childCount > 0) {
                    liContent = '<a href="#viewerPage" data-bookmark-page="' + bm.GetPageNumber() + '">' + liContent +
                    '</a><a data-shadow="false"  data-bookmark-level="'+ level + j + '"></a>';
                } else {
                    liContent = '<a  href="#viewerPage" data-bookmark-page="' + bm.GetPageNumber() + '">' + liContent + '</a>';
                }
                var newLiString = '<li  data-icon="false" class="bookmark-item"  data-pagenumber="' + bm.GetPageNumber() + '">' + liContent + '</li>';
...
$(function() {
    ...
    function initializeReaderControl() {
        ...
        window.ControlUtils.byteRangeCheck(function(status) {
            ...
            if (status === 200) {
                window.readerControl.oldBrowser = true;
                streaming = true;
            }
