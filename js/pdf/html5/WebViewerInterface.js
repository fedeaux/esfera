...
(function(exports) {
    ...
    WebViewerInterface.prototype = {
         ...
         */
        fitHeight: function() { unsupportedFunction(); },
         ...
         */
        fitPage: function() { unsupportedFunction(); },
         ...
         */
        setCurrentPageNumber: function(pageNumber) { unsupportedFunction(); },
         ...
         */
        getLayoutMode: function() { unsupportedFunction(); },
         ...
         */
        getShowSideWindow: function() { unsupportedFunction(); },
         ...
         */
        setShowSideWindow: function(value) { unsupportedFunction(); },
        
        /**
         * Gets the current tool mode
         * @returns {object} the current tool mode
         */
        getToolMode: function() { unsupportedFunction(); },
         ...
         */
        goToNextPage: function() { unsupportedFunction(); },
         ...
         */
        goToPrevPage: function() { unsupportedFunction(); },
         ...
         */
        loadDocument: function(url) { unsupportedFunction(); },
        
        /**
         * Rotates the document viewer's orientation by 90 degrees clockwise.
         */
        rotateClockwise: function() { unsupportedFunction(); },
        
        /**
         * Rotates the document viewer's orientation by 90 degrees counter clockwise.
         */
        rotateCounterClockwise: function() { unsupportedFunction(); },
         ...
         */
        searchText: function(pattern, searchMode) { unsupportedFunction(); },
         ...
         */
        setOnPageChangeCallback: function(callback) { unsupportedFunction(); },
         ...
         */
        setOnPageZoomCallback: function(callback) { unsupportedFunction(); }
    };
